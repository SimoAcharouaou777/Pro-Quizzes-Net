            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-end">
                        <button type="button" class="btn btn-success" id="addClassButton" >Join a Class</button> 
                    </div>
                </div>
                    ...
                    @foreach ($chunk as $class)
                        <div class="col-md-4 mb-4">
                            <div class="card h-100" style="border: 1px solid #f0f0f0;">
                                <a href="{{ route('MyclassDetails', ['id' => $class->id]) }}"> 
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="addClassModalLabel">Join A Class</h5>
                      <button type="button" id="closebutton" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <form method="POST" action="{{route('joinClass')}}" enctype="multipart/form-data">
                      @csrf
                      <div class="modal-body">
                        <div class="form-group">
                            <label for="classPassCode">Class Pass Code</label>
                            <input type="text" class="form-control" id="classPassCode" name="pass_code">
                        </div>
                    </div>
